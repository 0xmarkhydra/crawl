(function() {
    ...
    (function() {
        function Aa() {
            function a() {
                if (!a.yc) la = a.yc = m, ma = D, c.a(F, function(a) {
                    a.mc()
                })
            }
        ...
        function Ba() {
            y.init = function(a, b, d) {
                ...
                else if (a) d = S(a, b, "mixpanel"), d.ha(), F.mixpanel = d;
                y = d;
                1 === ca && (w.mixpanel = y);
                Ca()
            }
        ...
        function n(a) {
            ...
            var b = a.persistence;
            if ("cookie" !== b && "localStorage" !== b) o.H("Unknown persistence type " + b + "; falling back to cookie"), b = a.persistence = "cookie";
            this.i = "localStorage" ===
                b && c.localStorage.qa() ? c.localStorage : c.cookie;
            this.load();
            this.gc(a);
            this.qd(a);
            this.save()
        ...
        function C(a, b) {
            ...
            this.na = this.A.batch_flush_interval_ms;
            this.ta = !this.A.batch_autostart;
            this.Ia = 0;
            this.F = {}
        }
        ...
        function ta(a, b) {
            if (Ka(b)) return o.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'), m;
            var d = "0" === V(b).get(W(a, b));
            d && o.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data.");
            return d
        }
        ...
        function La(a, b) {
            b = b || {};
            V(b).remove(W(a, b), !!b.tb, b.rb)
        }

        function V(a) {
            a = a || {};
            return "localStorage" === a.Mb ? c.localStorage : c.cookie
        }
        ...
        function sa(a, b, d) {
            !c.Ta(b) || !b.length ? o.error("gdpr." + (a ? "optIn" : "optOut") + " called with an invalid token") : (d = d || {}, V(d).set(W(b, d), a ? 1 : 0, c.Fb(d.sb) ? d.sb : q, !!d.tb, !!d.Tc, !!d.vc, d.rb), d.o && a && d.o(d.jd || "$opt_in", d.kd, {
                send_immediately: m
            }))
        }
            ...
            return function() {
                ...
                try {
                    var c = b.call(this, "token"),
                        ...
                        r = b.call(this, "opt_out_tracking_cookie_prefix"),
                    ...
                    o.error("Unexpected error when checking tracking opt-out status: " + e)
                }
        ...
        var B = Array.prototype,
            ...
            o = {
                ...
                warn: function() {
                    if (J && !c.g(z) && z) {
                        var a = ["Mixpanel warning:"].concat(c.M(arguments));
                        try {
                            z.warn.apply(z, a)
                        } catch (b) {
                            c.a(a, function(a) {
                ...
                error: function() {
                    if (J && !c.g(z) && z) {
                        var a = ["Mixpanel error:"].concat(c.M(arguments));
                        try {
                            z.error.apply(z, a)
                        } catch (b) {
                            c.a(a, function(a) {
        ...
        c.M = function(a) {
            return !a ? [] : a.M ? a.M() : c.isArray(a) || c.Gc(a) ? K.call(a) : c.sd(a)
        };
        ...
        c.Ka = function(a) {
            c.a(a, function(b, d) {
                c.Hc(b) ? a[d] = c.Ac(b) : c.e(b) && (a[d] = c.Ka(b))
            });
            return a
        };
                    ...
                    switch (typeof s) {
                        ...
                        case "object":
                            ...
                            if ("[object Array]" === Q.apply(s)) {
                                i = s.length;
                                for (r = 0; r < i; r += 1) p[r] = b(r, s) || "null";
                                return i = 0 === p.length ? "[]" : g ? "[\n" + g + p.join(",\n" + g) + "\n" + e + "]" : "[" + p.join(",") + "]"
                            }
                            for (r in s) X.call(s, r) && (i = b(r, s)) && p.push(d(r) + (g ? ": " : ":") + i);
                        ...
                        a: {
                            ...
                            if ("{" === i) {
                                ...
                                for (; i;) {
                                    ...
                                    b();
                                    h(":");
                                    Object.hasOwnProperty.call(k, r) && g('Duplicate key "' + r + '"');
                                    k[r] = s();
                                    b();
                                    if ("}" === i) {
                                        h("}");
        ...
        c.eb = function() {
            ...
            function b() {
                var a = 1 * new Date,
                    b;
                if (w.performance &&
                    w.performance.now) b = w.performance.now();
                else
        ...
        c.Oa = function(a, b) {
            ...
            try {
                ...
                o.error("Skipping decoding for malformed query param: " +
                    c)
            }
            return c.replace(/\+/g, " ")
        };
        c.cookie = {
            ...
            parse: function(a) {
                var b;
                try {
                    b = c.P(c.cookie.get(a)) || {}
                } catch (d) {}
                return b
            },
            xd: function(a, b, c, f, h, g, e) {
                var i = "",
                    k = "",
                    p = "";
                ...
                h && (p += "; secure");
                u.cookie = a + "=" + encodeURIComponent(b) + k + "; path=/" + i + p
            },
        ...
        c.localStorage = {
            qa: function(a) {
                (a = U(q, a)) || o.error("localStorage unsupported; falling back to cookie store");
                return a
            },
            error: function(a) {
            ...
            parse: function(a) {
                try {
                    return c.P(c.localStorage.get(a)) || {}
                } catch (b) {}
                return q
            },
            set: function(a, b) {
        ...
        c.Pb = function() {
            ...
            return function(b, c, h, g, e) {
                b ? b.addEventListener && !g ? b.addEventListener(c, h, !!e) : (c = "on" + c, b[c] = a(b, h, b[c])) : o.error("No valid element provided to register_event")
            }
        }();
        var Na = /^(\w*)\[(\w+)([=~\|\^\$\*]?)=?"?([^\]"]*)"?\]$/;
        c.xc = function() {
            ...
            function b(b) {
                ...
                for (i = 0; i < b.length; i++)
                    ...
                    for (k = e = 0; k < x.length; k++) {
                        s = "*" == d ? x[k].all ? x[k].all : x[k].getElementsByTagName("*") : x[k].getElementsByTagName(d);
                        for (p = 0; p < s.length; p++) g[e++] = s[p]
                    }
                    x = [];
                    for (k = d = 0; k < g.length; k++) g[k].className && c.Ta(g[k].className) && a(g[k], v) && (x[d++] = g[k])
            ...
            var d = /[\t\r\n]/g;
            return function(a) {
                return c.Ic(a) ? [a] : c.e(a) && !c.g(a.length) ? a : b.call(this, a)
            }
        }();
        ...
        c.info = {
            ...
            Jc: function() {
                return c.extend(c.info.ka(), c.info.qb())
            },
            Rc: function(a) {
            ...
            Sc: function(a) {
                var b = c.info.Rc(a),
                    d = {};
                if (b !== q) d.$search_engine = b, a = c.Oa(a, "yahoo" != b ? "q" : "p"), a.length && (d.mp_keyword = a);
                return d
            },
            ja: function(a, b, d) {
            ...
            X: function() {
                return c.extend(c.ua({
                    $os: c.info.Jb(),
                    $browser: c.info.ja(A, I.vendor, Y),
                    $referrer: u.referrer,
                    $referring_domain: c.info.Ob(u.referrer),
                    $device: c.info.xb(A)
                }), {
            ...
            Kc: function() {
                return c.ua({
                    ...
                    current_domain: w.location.hostname,
                    current_url_path: w.location.pathname,
                    current_url_protocol: w.location.protocol,
                    current_url_search: w.location.search
                })
            }
        };
        ...
        E.prototype.o = function(a, b, d, f) {
            var h = this,
                g = c.xc(a);
            if (0 === g.length) o.error("The DOM query (" + a + ") returned 0 elements");
            else return c.a(g, function(a) {
                c.Pb(a, this.Kb, function(a) {
                    var c = {},
                        g = h.ma(d, this),
                        e = h.Gb.c("track_links_timeout");
                    h.Ma(a, this, c);
                    window.setTimeout(h.bc(f, g, c, m), e);
                    h.Gb.o(b, g, h.bc(f, g, c))
                })
            }, this), m
        };
        E.prototype.bc = function(a, b, c, f) {
            var f =
                f || D,
                h = this;
            return function() {
                if (!c.uc) c.uc = m, a && a(f, b) === D || h.Fa(b, c, f)
            }
        };
        ...
        L.prototype.ma = function(a, b) {
            var c = L.fd.ma.apply(this, arguments);
        ...
        var Qa = ga("lock");
        qa.prototype.cb = function(a, b, c) {
            function f() {
                j.setItem(u, "1");
                try {
                    a()
                } finally {
                    j.removeItem(u), j.getItem(o) === k && j.removeItem(o), j.getItem(n) === k && j.removeItem(n)
                }
            }
            ...
            function i(a) {
                (new Date).getTime() - p > v ? (Qa.error("Timeout waiting for mutex on " + s + "; clearing lock. [" + k + "]"), j.removeItem(u), j.removeItem(o), h()) : setTimeout(function() {
                    try {
                        a()
                    } catch (c) {
                        b && b(c)
        ...
        G.prototype.La = function(a, b, d) {
            ...
            this.Ua.cb(c.bind(function() {
                var b;
                try {
                    var c = this.$();
                    c.push(f);
                    (b = this.Xa(c)) && this.G.push(f)
                } catch (e) {
                ...
                if (b.length < a) {
                    ...
                    if (d.length) {
                        ...
                        for (var h = 0; h < d.length; h++) {
                            var g = d[h];
                            if ((new Date).getTime() > g.flushAfter && !f[g.id] && (g.Mc = m, b.push(g), b.length >= a)) break
                        }
                    }
                }
                return b
            ...
            var f = c.bind(function() {
                ...
                try {
                    var c = this.$(),
                        c = oa(c, d);
                    if (b = this.Xa(c))
                        for (var c = this.$(), f = 0; f < c.length; f++) {
                            var e = c[f];
        ...
        G.prototype.$ = function() {
            var a;
            try {
                if (a = this.i.getItem(this.L)) a = aa(a), c.isArray(a) || (this.h("Invalid storage entry:", a), a = q)
            } catch (b) {
        ...
        G.prototype.Xa = function(a) {
            try {
                return this.i.setItem(this.L, $(a)), m
            } catch (b) {
        ...
        C.prototype.stop = function() {
            this.ta = m;
            if (this.$a) clearTimeout(this.$a), this.$a = q
        };
        ...
        C.prototype.aa = function() {
            this.Tb(this.A.batch_flush_interval_ms)
        };
        C.prototype.Tb = function(a) {
            this.na = a;
            if (!this.ta) this.$a = setTimeout(c.bind(this.flush, this), this.na)
        };
        C.prototype.flush = function(a) {
            try {
                if (this.Rb) R.log("Flush: Request already in progress");
                else {
                    var a = a || {},
                    ...
                    if (1 > e.length) this.aa();
                        ...
                        var i = c.bind(function(e) {
                                ...
                                try {
                                    ...
                                    if (a.ec) this.Y.pd(r);
                                    ...
                                    else if (c.e(e) && e.O && (500 <= e.O.status || 429 === e.O.status || "timeout" === e.error)) {
                                        var i = 2 * this.na,
                                            k = e.O.responseHeaders;
                                        if (k) {
                                            var j = k["Retry-After"];
                                        ...
                                        this.Tb(i)
                                    } else if (c.e(e) && e.O && 413 === e.O.status)
                                        if (1 < h.length) {
                                            var p = Math.max(1, Math.floor(f / 2));
                                            this.C = Math.min(this.C, p, h.length -
                                                1);
                                            this.h("413 response; reducing batch size to " + this.C);
                                            this.aa()
                                        } else this.h("Single-event request too large; dropping", h), this.Sb(), g = m;
                                    else g = m;
                                    g && (this.Y.Oc(c.map(h, function(a) {
                                        return a.id
                                    }), c.bind(function(a) {
                                        a ? (this.Ia = 0, this.flush()) : (this.h("Failed to remove items from queue"), 5 < ++this.Ia ? (this.h("Too many queue failures; disabling batching system."), this.dd()) : this.aa())
                                    ...
                                    this.h("Error handling API response", n), this.aa()
                                }
                            }, this),
                            k = {
                                method: "POST",
                        ...
                        if (a.ec) k.ab = "sendBeacon";
                        R.log("MIXPANEL REQUEST:", e);
                        this.Uc(e, k, i)
                    }
                }
            } catch (j) {
                this.h("Error flushing request queue", j), this.aa()
            }
        };
        ...
        t.prototype.ba = N(function(a, b, d) {
            var f = this.Yb(a, b);
            c.e(a) && (d = b);
            return this.k(f,
                d)
        });
        t.prototype.va = N(function(a, b) {
            return this.k(this.fc(a), b)
        });
        t.prototype.ca = N(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.dc(a, b), d)
        });
        ...
        t.prototype.set_once = t.prototype.ba;
        t.prototype.union = t.prototype.ca;
        t.prototype.unset = t.prototype.va;
        ...
        j.prototype.set = H(function(a, b, d) {
            var f =
                this.Vb(a, b);
            c.e(a) && (d = b);
            this.p("save_referrer") && this.d.persistence.bb(document.referrer);
            f.$set = c.extend({}, c.info.Nc(), this.d.persistence.Dc(), f.$set);
            return this.k(f, d)
        });
        j.prototype.ba = H(function(a, b, d) {
            var f = this.Yb(a, b);
            c.e(a) && (d = b);
            return this.k(f, d)
        });
        ...
        j.prototype.Cb = H(function(a, b, d) {
            var f = {},
                e = {};
            c.e(a) ? (c.a(a, function(a, b) {
                this.z(b) || (isNaN(parseFloat(a)) ? o.error("Invalid increment value passed to mixpanel.people.increment - must be a number") :
                    e[b] = a)
        ...
        j.prototype.append = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.sc(a, b), d)
        });
        j.prototype.remove = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.Qb(a, b), d)
        });
        j.prototype.ca = H(function(a, b, d) {
            c.e(a) && (d = b);
            return this.k(this.dc(a, b), d)
        });
        j.prototype.ld = H(function(a, b, d) {
            if (!c.Fb(a) && (a = parseFloat(a), isNaN(a))) {
                o.error("Invalid value passed to mixpanel.people.track_charge - must be a number");
                return
            }
        ...
        j.prototype.wb = function() {
            ...
            o.error("mixpanel.people.delete_user() requires you to call identify() first")
        };
        ...
        j.prototype.k = function(a, b) {
            ...
            d = c.Ka(a);
            return !this.Ca() ? (this.nc(a), c.g(b) || (this.p("verbose") ? b({
                status: -1,
                error: q
        ...
        j.prototype.Ca = function() {
            return this.d.R.zb === m
        };
        j.prototype.nc = function(a) {
            "$set" in a ? this.d.persistence.q("$set", a) : "$set_once" in a ? this.d.persistence.q("$set_once", a) : "$unset" in
                a ? this.d.persistence.q("$unset", a) : "$add" in a ? this.d.persistence.q("$add", a) : "$append" in a ? this.d.persistence.q("$append", a) : "$remove" in a ? this.d.persistence.q("$remove", a) : "$union" in a ? this.d.persistence.q("$union", a) : o.error("Invalid call to _enqueue():", a)
        };
        j.prototype.S = function(a, b, d, f) {
            var e = this,
                g = c.extend({}, this.d.persistence.W(a)),
                r = g;
            !c.g(g) && c.e(g) && !c.pa(g) && (e.d.persistence.v(a, g), e.d.persistence.save(), f && (r = f(g)), b.call(e, r, function(b, f) {
                0 === b && e.d.persistence.q(a, g);
                c.g(d) || d(b, f)
            }))
        };
        j.prototype.oc = function(a, b, d, f, e, g, r) {
            var i = this;
            this.S("$set", this.set, a);
            this.S("$set_once", this.ba, f);
            this.S("$unset", this.va, g, function(a) {
                return c.keys(a)
            });
            this.S("$add", this.Cb, b);
            this.S("$union", this.ca, e);
            a = this.d.persistence.W("$append");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var k, b = function(a, b) {
                        0 === a && i.d.persistence.q("$append", k);
                        c.g(d) || d(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.W("$append"), k = a.pop(), i.d.persistence.save(), c.pa(k) || i.append(k, b);
            a = this.d.persistence.W("$remove");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var j, b = function(a, b) {
                        0 === a && i.d.persistence.q("$remove", j);
                        c.g(r) || r(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.W("$remove"), j = a.pop(), i.d.persistence.save(), c.pa(j) || i.remove(j, b)
        };
        ...
        j.prototype.set_once = j.prototype.ba;
        j.prototype.unset = j.prototype.va;
        j.prototype.increment = j.prototype.Cb;
        j.prototype.append =
            j.prototype.append;
        j.prototype.remove = j.prototype.remove;
        j.prototype.union = j.prototype.ca;
        j.prototype.track_charge = j.prototype.ld;
        j.prototype.clear_charges = j.prototype.ob;
        j.prototype.delete_user = j.prototype.wb;
        ...
        n.prototype.save = function() {
            this.disabled || this.i.set(this.name, c.ea(this.props), this.Na, this.Ja, this.Ub, this.ub, this.la)
        };
        ...
        n.prototype.remove = function() {
            this.i.remove(this.name, D, this.la);
            this.i.remove(this.name, m, this.la)
        };
        ...
        n.prototype.w = function(a, b, d) {
            return c.e(a) ? ("undefined" === typeof b && (b = "None"), this.Na = "undefined" === typeof d ? this.vb : d, this.load(), c.a(a, function(a,
                c) {
                if (!this.props.hasOwnProperty(c) || this.props[c] === b) this.props[c] = a
            }, this), this.save(), m) : D
        };
        n.prototype.m = function(a, b) {
            return c.e(a) ? (this.Na = "undefined" === typeof b ? this.vb : b, this.load(), c.extend(this.props, a), this.save(), m) : D
        };
        ...
        n.prototype.bb = function(a) {
            this.w({
                ...
                $initial_referring_domain: c.info.Ob(a) || "$direct"
            }, "")
        };
        n.prototype.Dc =
            function() {
        ...
        n.prototype.gc = function(a) {
            this.vb = this.Na = a.cookie_expiration;
            this.Xb(a.disable_persistence);
            this.Xc(a.cookie_domain);
            this.Yc(a.cross_site_cookie);
            this.Zc(a.cross_subdomain_cookie);
            this.bd(a.secure_cookie)
        };
        n.prototype.Xb = function(a) {
            (this.disabled = a) ? this.remove(): this.save()
        };
        n.prototype.Xc = function(a) {
            if (a !== this.la) this.remove(), this.la = a, this.save()
        };
        n.prototype.Yc =
            function(a) {
                if (a !== this.ub) this.ub = a, this.remove(), this.save()
            };
        ...
        n.prototype.bd = function(a) {
            if (a !== this.Ub) this.Ub = a ? m : D, this.remove(), this.save()
        };
        n.prototype.q = function(a, b) {
            ...
            "__mps" === d ? (c.extend(e, f), this.v("$add",
                ...
                }), this.v("$unset", f)) : "__mpr" === d ? (p.push(f), this.v("$append", f)) : "__mpap" ===
        ...
        n.prototype.Pc = function(a) {
            var b = (this.ra("__timers") || {})[a];
            c.g(b) || (delete this.props.__timers[a], this.save());
            return b
        };
        var ca, y, O = w.XMLHttpRequest && "withCredentials" in
            new XMLHttpRequest,
        ...
        e.prototype.Ra = function(a, b, d) {
            ...
            else return a = S(a, b, d), y[d] = a, a.ha(), a
        };
        e.prototype.U = function(a, b, d) {
            ...
            this.config = {};
            var e = {};
            "api_payload_format" in b || (b.api_host || za.api_host).match(/\.mixpanel\.com/) && (e.api_payload_format =
                "json");
            this.Wb(c.extend({}, za, e, b, {
                name: d,
                token: a,
            ...
            this.u = {};
            if (this.Q = this.c("batch_requests"))
                if (!c.localStorage.qa(m) || !O) this.Q = D, o.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"), c.a(this.yb(), function(a) {
                    o.log("Clearing batch queue " + a.Z);
                    c.localStorage.remove(a.Z)
                });
                else if (this.Fc(), ba && w.addEventListener) {
                var h =
                    c.bind(function() {
                        this.u.J.ta || this.u.J.flush({
                            ec: m
                        })
                    }, this);
                w.addEventListener("pagehide", function(a) {
                    a.persisted && h()
                });
        ...
        e.prototype.mb = function() {
            this.persistence.hc(u.referrer);
            this.c("store_google") &&
                this.m(c.info.ka());
            this.c("save_referrer") && this.persistence.bb(u.referrer)
        };
        e.prototype.mc = function() {
            c.a(this.xa, function(a) {
                this.Da.apply(this, a)
            }, this);
            this.V() || c.a(this.ya, function(a) {
                this.k.apply(this, a)
            }, this);
            delete this.xa;
            delete this.ya
        ...
        e.prototype.k = function(a, b, d, e) {
            ...
            var g = {
                    ...
                    ab: this.c("api_transport"),
                    ic: this.c("verbose")
                },
                j = q;
            if (!e && (c.Sa(d) || "string" === typeof d)) e = d, d = q;
            d = c.extend(g, d || {});
            if (!O) d.method = "GET";
            var g = "POST" === d.method,
                i = ba && g && "sendbeacon" === d.ab.toLowerCase(),
                k = d.ic;
            b.verbose && (k = m);
            this.c("test") && (b.test =
                1);
            ...
            if ("img" in b) j = u.createElement("img"), j.src = a, u.body.appendChild(j);
                ...
                if (d.ac && "undefined" !== typeof v.timeout) {
                    v.timeout = d.ac;
                        ...
                        if (200 === v.status) {
                            if (e)
                                if (k) {
                                    var a;
                                    try {
                                        a = c.P(v.responseText)
                                    } catch (b) {
                                        if (n.l(b), d.Ec) a = v.responseText;
                                        else return
                                    }
                                    e(a)
                                } else e(Number(v.responseText))
                        } else a = v.timeout && !v.status && (new Date).getTime() - w >= v.timeout ? "timeout" : "Bad HTTP status: " +
                            v.status + " " + v.statusText, n.l(a), e && (k ? e({
                                status: 0,
                                error: a,
                                O: v
                            }) : e(0))
        ...
        e.prototype.za = function(a) {
            ...
            c.a(a, function(a) {
                a && (d = a[0], c.isArray(d) ?
                    g.push(a) : "function" === typeof a ? a.call(this) : c.isArray(a) && "alias" === d ? e.push(a) : c.isArray(a) && -1 !== d.indexOf("track") && "function" === typeof this[d] ? g.push(a) : h.push(a))
            }, this);
            b(e, this);
            b(h, this);
            b(g, this)
            ...
            function() {
                if (!this.nb()) {
                    var a = c.bind(function(a) {
                            return new C(a.Z, {
                                A: this.config,
                                Vc: c.bind(function(b, c, e) {
                                    this.k(this.c("api_host") + a.D, this.hb(b), c, this.jb(e, b))
                                }, this),
                                ia: c.bind(function(b) {
                                    return this.lb("before_send_" + a.type, b)
                                }, this),
                                I: this.c("error_reporter"),
                                ed: c.bind(this.Za, this)
                            })
                        }, this),
                        b = this.yb();
                    this.u = {
                ...
                this.c("batch_autostart") && this.Ya()
            };
        e.prototype.Ya = function() {
            this.kc = m;
            if (this.nb()) this.Q = m, c.a(this.u, function(a) {
                a.start()
            })
        };
        e.prototype.Za =
        ...
        e.prototype.disable = function(a) {
            "undefined" === typeof a ? this.R.wc = m : this.wa = this.wa.concat(a)
        };
        e.prototype.hb = function(a) {
            a = c.ea(a);
            "base64" === this.c("api_payload_format") && (a = c.tc(a));
            return {
                data: a
            }
        };
        e.prototype.Ea = function(a, b) {
            var d = c.truncate(a.data, 255),
                ...
                i = m,
                k = c.bind(function() {
                    j.Zb || (d = this.lb("before_send_" + a.type, d));
                    return d ? (o.log("MIXPANEL REQUEST:"),
                        o.log(d), this.k(e, this.hb(d), j, this.jb(b, d))) : q
                }, this);
            this.Q && !g ? h.La(d, function(a) {
                a ? b(1, d) : k()
            }) : i = k();
            return i && d
        };
        e.prototype.o = M(function(a, b, d, e) {
            ...
            else if (this.ib(a)) e(0);
            else {
                b = c.extend({}, b);
                b.token = this.c("token");
                var g = this.persistence.Pc(a);
                c.g(g) || (b.$duration = parseFloat((((new Date).getTime() - g) / 1E3).toFixed(3)));
                this.mb();
                g = this.c("track_marketing") ? c.info.Jc() : {};
                b = c.extend({}, c.info.X(), g, this.persistence.X(), this.N, b);
        ...
        e.prototype.ad = M(function(a, b, d) {
            c.isArray(b) || (b = [b]);
            var e = {};
            e[a] = b;
            this.m(e);
        ...
        e.prototype.qc =
            M(function(a, b, c) {
                ...
                return this.people.ca(a, b, c)
            });
        e.prototype.Qc = M(function(a, b, c) {
            var e = this.s(a);
            if (e !== l) {
                var h = e.indexOf(b); - 1 < h && (e.splice(h, 1), this.m({
                    wd: e
                }));
                0 === e.length && this.da(a)
            }
            return this.people.remove(a, b, c)
        });
        e.prototype.od = M(function(a, b, d, e) {
            var h = c.extend({}, b || {});
            c.a(d, function(a, b) {
                a !== q && a !== l && (h[b] = a)
            });
        ...
        e.prototype.Cc = function(a, b) {
            var c = this.lc(a, b),
                e = this.gb[c];
            if (e === l || e.Ba !== a || e.Aa !== b) e = new t, e.U(this, a, b), this.gb[c] = e;
            return e
        };
        e.prototype.cc = M(function(a, b) {
            "object" !== typeof a && (a = {});
            var b = b || {},
                d = b.event_name || "$mp_web_page_view",
                e = c.extend(c.info.Kc(), c.info.ka(), c.info.qb()),
                e = c.extend({}, e, a);
            return this.o(d, e)
        });
        ...
        e.prototype.gd = function(a) {
            c.g(a) ? this.l("No event name provided to mixpanel.time_event") :
                this.ib(a) || this.persistence.$c(a)
        };
        var Da = {
            persistent: m
        };
        e.prototype.m = function(a, b) {
            var d = da(b);
            d.persistent ? this.persistence.m(a, d.days) : c.extend(this.N, a)
        };
        e.prototype.w = function(a, b, d) {
            d = da(d);
            d.persistent ? this.persistence.w(a, b, d.days) : ("undefined" === typeof b && (b = "None"), c.a(a, function(a, c) {
                if (!this.N.hasOwnProperty(c) || this.N[c] === b) this.N[c] = a
            }, this))
        };
        e.prototype.da = function(a, b) {
            b = da(b);
            b.persistent ? this.persistence.da(a) : delete this.N[a]
        };
        ...
        e.prototype.Qa = function(a, b, c, e, h, g, j, i) {
            var k = this.K();
            if (a && k !== a) {
            ...
            a !== k && a !== this.s("__alias") && (this.da("__alias"), this.m({
                distinct_id: a
            }));
            this.R.zb = m;
            this.people.oc(b, c, e, h, g, j, i);
            a !== k && this.o("$identify", {
                distinct_id: a,
                $anon_distinct_id: k
            }, {
        ...
        e.prototype.rc = function(a, b) {
            ...
            var d = this;
            c.g(b) && (b = this.K());
            if (a !== b) return this.kb("__alias", a), this.o("$create_alias", {
                alias: a,
                distinct_id: b
            }, {
                Zb: m
        ...
        e.prototype.Lc = function(a) {
            this.kb("mp_name_tag", a)
        };
        e.prototype.Wb = function(a) {
            if (c.e(a)) c.extend(this.config, a), a.batch_size && c.a(this.u, function(a) {
                a.Sb()
            }), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") || (this.config.disable_persistence = this.config.disable_cookie), this.persistence && this.persistence.gc(this.config), J = J || this.c("debug")
        };
        ...
        e.prototype.ib = function(a) {
            return c.Eb(A) || this.R.wc || c.Bb(this.wa, a)
        };
        e.prototype.pc = function() {
            "localStorage" === this.c("opt_out_tracking_persistence_type") && c.localStorage.qa() && (!this.oa() && this.oa({
            ...
            else if (!this.oa() && (this.c("opt_out_tracking_by_default") || c.cookie.get("mp_optout"))) c.cookie.remove("mp_optout"), this.Va({
        ...
        e.prototype.fa = function(a) {
            ...
            !this.c("disable_persistence") && this.persistence.disabled !== a && this.persistence.Xb(a);
            a ? this.Za() : this.kc && this.Ya()
        };
        e.prototype.T = function(a, b) {
            ...
            c.localStorage.qa() || (b.persistence_type = "cookie");
            return a(this.c("token"), {
                o: b.track,
                jd: b.track_event_name,
                kd: b.track_properties,
                Mb: b.persistence_type,
                Lb: b.cookie_prefix,
                rb: b.cookie_domain,
                sb: b.cookie_expiration,
                vc: b.cross_site_cookie,
                tb: b.cross_subdomain_cookie,
                Tc: b.secure_cookie,
                Ab: b.ignore_dnt
            })
        };
        ...
        e.prototype.Va = function(a) {
            a = c.extend({
                ...
                a);
            a.delete_user && this.people && this.people.Ca() && (this.people.wb(), this.people.ob());
            this.T(Ia, a);
            this.fa(a)
        };
        ...
        e.prototype.init = e.prototype.Ra;
        e.prototype.reset =
            e.prototype.reset;
        e.prototype.disable = e.prototype.disable;
        e.prototype.time_event = e.prototype.gd;
        e.prototype.track = e.prototype.o;
        e.prototype.track_links = e.prototype.nd;
        e.prototype.track_forms = e.prototype.md;
        e.prototype.track_pageview = e.prototype.cc;
        e.prototype.register = e.prototype.m;
        e.prototype.register_once = e.prototype.w;
        e.prototype.unregister = e.prototype.da;
        e.prototype.identify = e.prototype.Qa;
        e.prototype.alias = e.prototype.rc;
        e.prototype.name_tag = e.prototype.Lc;
        e.prototype.set_config = e.prototype.Wb;
        ...
        e.prototype.opt_out_tracking = e.prototype.Va;
        e.prototype.opt_in_tracking = e.prototype.Ib;
        e.prototype.has_opted_out_tracking = e.prototype.V;
        e.prototype.has_opted_in_tracking = e.prototype.oa;
        e.prototype.clear_opt_in_out_tracking = e.prototype.pb;
        e.prototype.get_group = e.prototype.Cc;
        e.prototype.set_group = e.prototype.ad;
        e.prototype.add_group = e.prototype.qc;
        e.prototype.remove_group = e.prototype.Qc;
        e.prototype.track_with_groups = e.prototype.od;
        e.prototype.start_batch_senders = e.prototype.Ya;
        e.prototype.stop_batch_senders = e.prototype.Za;
        e.prototype.DEFAULT_API_ROUTES = B;
        n.prototype.properties = n.prototype.X;
        n.prototype.update_search_keyword = n.prototype.hc;
        n.prototype.update_referrer_info = n.prototype.bb;
        n.prototype.get_cross_subdomain = n.prototype.Bc;
        n.prototype.clear = n.prototype.clear;
        var F = {};
        (function() {
            ca = 1;
            y = w.mixpanel;
            c.g(y) ? o.H('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.') :
